"""Studio lighting and inspection cameras for the Zeus armor prototypes; not MU screenshots."""
import math
...
FRAMING = {'Armor': (136, 132), 'Pant': (84, 150), 'Glove': (100, 150), 'Boot': (30, 96)}
...
def studio(target=110):
    ...
    for name, location, energy, color, size in (
            ('Key', (-95, -150, target + 15), 650000, (1, .9, .78), 110),
            ('Fill', (100, -80, target - 95), 360000, (.55, .75, 1), 100),
            ('Rim', (35, 75, target + 5), 900000, (.8, .88, 1), 100)):
    ...
    camera_data = bpy.data.cameras.new('Zeus armor inspection camera')
