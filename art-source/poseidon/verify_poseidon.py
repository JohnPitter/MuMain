...
from poseidon_export import ANCHORS, HAND_TRANSFORM
from verify_prop_roundtrip import compare, decoded_triangles


def main():
    output = ROOT / 'prototype'
    scene_file = output / 'poseidon-weapons.blend'
    ...
    print('POSEIDON_SAVED_ROUNDTRIP_VERIFIED', json.dumps(report), flush=True)
