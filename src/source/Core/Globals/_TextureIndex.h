...
enum
{
    ...
    // Reserved exclusively for SendGift/SendGiftConfirm; keep clear of legacy interface IDs (<=31729),
    // the interface sentinel at 32000, and effect IDs beginning at 32001.
    BITMAP_IGS_SEND_GIFT_BUTTON = 31900,
    BITMAP_IGS_SEND_GIFT_BACK,
    BITMAP_IGS_SEND_GIFT_UP,
    BITMAP_IGS_SEND_GIFT_DOWN,
    BITMAP_IGS_SEND_GIFT_LEFTLINE,
    BITMAP_IGS_SEND_GIFT_RIGHTLINE,
    BITMAP_IGS_SEND_GIFT_TEXTBOX,
    BITMAP_IGS_SEND_GIFT_CONFIRM_BUTTON,
    BITMAP_IGS_SEND_GIFT_CONFIRM_BACK,
    BITMAP_IGS_SEND_GIFT_CONFIRM_UP,
    BITMAP_IGS_SEND_GIFT_CONFIRM_DOWN,
    BITMAP_IGS_SEND_GIFT_CONFIRM_LEFTLINE,
    BITMAP_IGS_SEND_GIFT_CONFIRM_RIGHTLINE,
    BITMAP_IGS_SEND_GIFT_CONFIRM_TEXTBOX,
